...
{
    private static void MapSagaPlanningEndpoints(RouteGroupBuilder v1)
    {
        v1.MapGet("/families/{familyId:guid}/sagas", async (
            ...
            .WithName("LedgerListFamilyWorkflowSagas")
            .WithOpenApi();
        ...
        v1.MapGet("/families/{familyId:guid}/sagas/{sagaId:guid}", async (
            ...
            .RequireAuthorization(ApiAuthorizationPolicies.AnyFamilyMember)
            .WithName("LedgerGetFamilyWorkflowSaga")
            .WithOpenApi();
        ...
        v1.MapGet("/families/{familyId:guid}/sagas/{sagaId:guid}/timeline", async (
            ...
            .RequireAuthorization(ApiAuthorizationPolicies.AnyFamilyMember)
            .WithName("LedgerListFamilyWorkflowSagaTimeline")
            .WithOpenApi();
    }
}
