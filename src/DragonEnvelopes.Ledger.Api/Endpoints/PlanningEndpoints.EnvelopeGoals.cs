    ...
    private static void MapEnvelopeGoalPlanningEndpoints(RouteGroupBuilder v1)
    {
        v1.MapPost("/envelope-goals", async (
                ...
                CancellationToken cancellationToken) =>
            {
                ...
                var created = await envelopeGoalService.CreateAsync(
                    request.FamilyId,
                    request.EnvelopeId,
        ...
        v1.MapGet("/envelope-goals", async (
                ...
                CancellationToken cancellationToken) =>
            {
                ...
                var goals = await envelopeGoalService.ListByFamilyAsync(familyId, cancellationToken);
        ...
        v1.MapGet("/envelope-goals/{goalId:guid}", async (
                ...
                CancellationToken cancellationToken) =>
            {
                ...
                var goal = await envelopeGoalService.GetByIdAsync(goalId, cancellationToken);
                return goal is null
                    ? Results.NotFound()
        ...
        v1.MapPut("/envelope-goals/{goalId:guid}", async (
                ...
                CancellationToken cancellationToken) =>
            {
                ...
                var updated = await envelopeGoalService.UpdateAsync(
                    goalId,
                    request.TargetAmount,
                    request.DueDate,
                    request.Status,
        ...
        v1.MapDelete("/envelope-goals/{goalId:guid}", async (
                ...
                CancellationToken cancellationToken) =>
            {
                ...
                await envelopeGoalService.DeleteAsync(goalId, cancellationToken);
        ...
        v1.MapGet("/envelope-goals/projection", async (
                ...
                CancellationToken cancellationToken) =>
            {
                ...
                var projection = await envelopeGoalService.ProjectAsync(
                    familyId,
